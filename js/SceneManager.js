...
export class SceneManager
{
	...
	set_active_scene(type,scene_id,data)
	{
	    ...
	    if(type=='fear')
	    {
	    	...
	    	//this.active_scene.removeActionManager();
	    	...
	    	sceneManager.assettManager.loadfeartype_models(types,fearspace_data['fear_type_position']);
	    	sceneManager.assettManager.loadfear_space(space);
	    	sceneManager.assettManager.load_team_models(currentteam,fearspace_data['player_position']);
