...
import {spells} from './TeamData/spells.js';
export class TeamData
{
	...
	add_exp(exp)
	{
		this.data['teamdata']['experince'] += exp;
	}
	add_crystals(crystals)
	{
		this.data['teamdata']['crystals'] += crystals;
		this.player_hud.update_cyrstals(this.data['teamdata']['crystals']);
	}
